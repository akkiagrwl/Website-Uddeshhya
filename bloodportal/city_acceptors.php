...
<?php if(!isset($_POST['submit']))
	...
	?>
                        ...
                        <div class="panel-heading">
                            <center>Select Details To View Acceptors</center>
                        </div>
							...
							$city=$cit['Taluk'];?>
                              <table class="table-striped table-hover col-lg-12" id="dataTables-example">
                                ...
                                <tbody>
								<?php $i=1;
							$query="Select Id,Name,Age,Sex,BGroup,Address,City,State,pincode,phone,Alternate,email,Detail from donor where Type='AC' AND State='$stx' AND City='$city' And Last_Donated=''";
...
<button class="btn btn-primary" name="unable" value="<?php echo $id; ?>">Unable To Reach</button></form></center></div>
							<?php } ?>
									  </tbody>
                                 </table>
								 </div>
