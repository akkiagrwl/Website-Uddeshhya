...
require_once 'dbconnect.php';
			...
			if ($stmt3=mysqli_prepare($link, $qry))
			{
			mysqli_stmt_bind_param($stmt3, "s",$cemail);
			...
			if ($stmt4=mysqli_prepare($link, $qry))
			{
			echo $id;	
			mysqli_stmt_bind_param($stmt4, "sssssssssss",$id,$cname,$age,$gender,$scan,$cadd,$city,$state,$pin,$co,$alt);
			...
			if ($stmt5=mysqli_prepare($link, $qry))
			{
			mysqli_stmt_bind_param($stmt5, "ss",$id,$answ);
