...
function validate()
{
  ...
  var de=document.getElementById('detail').value;
			if(de=="")
			{
				alert("Enter Details of Requirements for Acceptor");
				de.focus;
				return false;
			}
...
<section id="container" class="sub-page">
	<div class="wrap-container zerogrid">
		...
		<form action="add_acceptor.php" method="post">
		<h3><center>Enter Acceptor Details Below:</center></h3>
		<div id="main-content">
			...
			<div class="col-lg-3">
				<div class="wrap-col">
					<input type="number" placeholder="Enter Contact.." class="form-control" id="alt_phone" name="alt_contact">
					</input>
				</div>
			</div>
			</div>
			...
			<div class="col-lg-1">
				<div class="wrap-col">
					<b>Detail of Acceptor*:</b>
				</div>
			</div>
			<div class="col-lg-3">
				<div class="wrap-col">
					<textarea placeholder="Enter Details Such As Condition of Acceptor and Units Needed" class="form-control" name="detail" id="detail"></textarea>
				</div>
			</div>
			</div>
			<br>
			...
			<br><center><button class="btn btn-success" name="submit" onclick="return validate();">Submit</button></center><br><p style="color:red;">* Marked Feilds are Mandatory</p>
				</div>
		</div> 
		</form>
	</div>
